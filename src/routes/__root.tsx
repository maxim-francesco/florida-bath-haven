          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              mainEntity: [
                ...
                ["Does the $6,000 shower package really cover everything?", "It covers the labor for a full shower rebuild: demolition and debris removal, new valve, drain and pipes, a built-in niche and seat, Durock cement board with full waterproofing, tile installed on the walls and shower floor, and shower doors fitted complete. Materials are not included in the $6,000 — they are billed separately. The labor carries a two-year warranty. Larger showers, or ones being moved to a new position, are quoted separately."],
              ].map(([name, text]) => ({
                "@type": "Question",
                name,
